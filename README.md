...
```javascript
gxsa = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gxsa@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var gxsa = require( 'path/to/vendor/umd/blas-ext-base-gxsa/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gxsa@umd/browser.js"></script>
```
